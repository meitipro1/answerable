...
from genlayer.storage import allow as allow_storage, DynArray, TreeMap
...
class Answerable(gl.contract.Contract):
    ...
    def claim(self, qid: int) -> None:
        ...
        # Top-level transfer: the only kind that works on Studio Next.
        gl.contract.get_at(q.desk).emit_transfer(q.pot)
